...
> [!WARNING] California's combination of high traffic volume, diverse terrain, and weather extremes makes many of its highways among the deadliest in the nation.

## The 10 Most Dangerous Roads in California

### 1. Interstate 5 (I-5)

**Route:** Mexican border to Oregon (796 miles)
**Annual Fatalities:** 150+ deaths
**Danger Zones:** Grapevine, Coalinga, Sacramento
...
**Route:** San Diego to Nevada border (287 miles)
**Danger Zone:** Cajon Pass
...
**Route:** Bakersfield to Red Bluff (424 miles)
**Notable:** One of California's deadliest non-interstate roads
...
**Route:** Santa Monica to Arizona border (244 miles)
**Danger Zone:** San Gorgonio Pass
...
1. **Florence & Normandie** (South LA)
2. **Sepulveda & Victory** (Van Nuys)
3. **Western & Florence** (South LA)
4. **Crenshaw & Slauson** (Hyde Park)
5. **Vermont & Manchester** (South LA)
...
> [!TIP] During tule fog season, check Caltrans QuickMap before traveling I-5 or SR-99. Consider delaying travel until fog lifts (usually by late morning).

### How to Drive in Tule Fog

1. **Slow down significantly** - Speed kills in low visibility
2. **Use low-beam headlights** - High beams reflect off fog
3. **Increase following distance** - 4+ seconds minimum
4. **Don't stop on the freeway** - Pull completely off if needed
5. **Turn off cruise control** - Maintain manual control
6. **Crack your window** - Listen for traffic sounds
...
> [!WARNING] California's minimums are dangerously low. A serious accident easily exceeds these limits, leaving you underinsured.

## Caltrans Safety Resources

Before traveling California's dangerous roads:
- **QuickMap:** [quickmap.dot.ca.gov](https://quickmap.dot.ca.gov) - Real-time traffic and road conditions
