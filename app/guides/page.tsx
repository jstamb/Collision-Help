          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
                Car Accident Guides & Resources
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed">
                Expert guidance to help you navigate insurance claims, understand your rights,
                and get back on the road. Written for real people dealing with real accidents.
              </p>
            </div>
          </div>
        </section>
                ...
                <div key={pillar.slug}>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      ...
                      >
                        View all {pillar.articles.length} articles →
                      </Link>
                    </li>
                  </ul>
                </div>
